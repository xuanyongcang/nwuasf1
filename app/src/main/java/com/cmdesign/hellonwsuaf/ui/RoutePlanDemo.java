...
public class RoutePlanDemo extends Activity implements BaiduMap.OnMapClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CharSequence titleLable = "定位与路线规划导航功能";
        setTitle(titleLable);
        //初始化地图
    ...
    public void SearchButtonProcess(View v) {
        ...
        PlanNode stNode = PlanNode.withLocation(ll2);
        PlanNode enNode = PlanNode.withCityNameAndPlaceName("咸阳", editEn.getText().toString());
